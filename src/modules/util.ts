...
export function getNormalizedParts(normalizedSlashedPath: string, rootLength: number) {
...
export function readFile(fileName: string, encoding?: string): string | undefined {
